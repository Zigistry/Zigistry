...
const gitlab_url = "https://gitlab.com/api/v4/projects?order_by=last_activity_at&per_page=100&topic=zig";

pub fn main() !void {
    var iter = hp.GitlabApiIterator.init(allocator, gitlab_url);
    hp.print("[", .{});
