...
const config = {
    ...
    kit: {
        ...
        prerender: {
            crawl: false,
            entries: [...out, '/', '/programs', '/about', '/apps', '/advancedSearch', '/help', '/statistics', '/packages', '/API-docs'],
