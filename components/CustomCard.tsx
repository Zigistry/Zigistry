    ...
    <Card className="w-72 my-2 hover:scale-110 hover:z-10 z-0 transition-transform transform-cpu">
      ...
      <p className="text-gray-400">
        ...
        <div className="flex space-x-3">
          {props.item.archived ?<Badge color={"light"} className="w-fit dark:bg-yellow-400 bg-white dark:border-none border-slate-200 border mt-4">Archived</Badge>: ""}
          <Badge color={"darkblue"} className="w-fit dark:bg-slate-600 bg-white dark:border-none border-slate-200 border mt-4">{props.item.license}</Badge>
