  ...
  return (
    <Navbar className="border-b-orange-300" style={{ borderBottom: "2px solid #faca15" }} rounded>
      ...
      <NavbarCollapse>
        ...
        <NavbarLink as={Link} className="github-button" href="https://github.com/rohanvashisht1234/zigistry" data-color-scheme="no-preference: light; light: light; dark:light;" data-size="small" data-show-count="true" aria-label="Star rohanvashisht1234/zigistry on GitHub">Star</NavbarLink>
        <Flowbite>
