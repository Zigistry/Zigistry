...
//! you can add your libraries/programs to Zigistry.
//!===============================================================
      ...
      <div className="readme">
        <div className="readmeDiv">
          <div className="flex">
            <div>
              ...
              <div className="text-xl">
                <ol>
                  <li>
                    On the main page of your GitHub repository, click on the Cog
                    wheel icon on the right of the screen
                  </li>
                  <li>You&apos;ll see a section named topics, click on it.</li>
                  <li>
                    Then in the text field type <strong>zig-package</strong>,
                    press enter (or return) and click save changes.
                  </li>
                  <li>
                  ...
                  <li>
                    Still facing issues or have suggestions? feel free to open
                    an issue{" "}
                    <Link
          ...
          <div>
            <ol>
              <li>
                The same steps as above but this time the topic would be{" "}
                <strong>Zig</strong> and not Zig-package.
              </li>
            </ol>
          </div>
        </div>
