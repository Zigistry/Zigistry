                    ...
                    <div class="grid grid-cols-1 gap-3 sm:gap-4 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        {:else}
                            {#each data.dependents as dependent}
                                ...
                                what I had implementeed for zigistry's architecture.
                                because, a package or a program can have
                                dependencies, but only a package be a dependency.
                                the real difference between package and a program.
                                -->
